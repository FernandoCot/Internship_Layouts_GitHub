            ...
            <footer className="footer_home">
                <div className="div_large div_footer_home">
                    <div className="div_footer col-12 col-lg-4">
                        <svg height="30" className="logo_footer_home" viewBox="0 0 45 16" version="1.1" width="84" aria-hidden="true">
                        ...
                        <div className="col-12 col-lg-6 p-0">
                            <div className="inner_right_footer">
                                <a href="https://twitter.com/github" className="" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 273.5 222.3" className="footer_home_social_networks" height="18">
                                        <g fill="currentColor">
                                ...
                                <a href="https://www.facebook.com/GitHub" className="" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.3 15.4" className="footer_home_social_networks" height="18">
                                        <g fill="currentColor">
                                ...
                                <a href="https://www.youtube.com/github" className="" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.17 13.6" className="footer_home_social_networks" height="16">
                                        <g fill="currentColor">
                                ...
                                <a href="https://www.linkedin.com/company/github" className="" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 18" className="footer_home_social_networks" height="18">
                                        <g fill="currentColor">
                                ...
                                <a href="https://github.com/github" className="" target="_blank" rel="noopener noreferrer">
                                    <svg height="20" className="footer_home_social_networks" alt="GitHub" viewBox="0 0 16 16" version="1.1" width="20" aria-hidden="true">
