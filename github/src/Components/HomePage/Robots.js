        ...
        return(
            <section className="Section_Robots">
                <div className="div_flex">
                    ...
                    <div className="col-5">
                        <Link to="https://github.com/features/code-review" className="link_robots">
                            <div className="container div_flex div_boxes_robot">
                                <div className="col-10 pad0">
                                    ...
                                    <p className="txt_robots">
                                        ...
                                        <span className="robots_inside_link">Learn about code review.</span>
                                    </p>
                                </div>
                                <div className="offset-1 col-1 pad0">
                        ...
                        <Link to="https://github.com/features/project-management" className="link_robots">
                            <div className="container div_flex div_boxes_robot">
                                <div className="col-10 pad0">
                                    ...
                                    <p className="txt_robots">
                                        ...
                                        <span className="robots_inside_link">Learn about project management.</span>
                                    </p>
                                </div>
                                <div className="offset-1 col-1 pad0">
                                    <svg class="octicon octicon-triangle-right triangle_blue" viewBox="0 0 6 16" version="1.1" width="6" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 14l6-6-6-6v12z"></path></svg>
                        ...
                        <Link to="https://github.com/features/integrations" className="link_robots">
                            <div className="container div_flex div_boxes_robot">
                                <div className="col-10 pad0">
                                    ...
                                    <p className="txt_robots">
                                        ...
                                        <span className="robots_inside_link">Learn about integrations.</span>
                                    </p>
                                </div>
                                <div className="offset-1 col-1 pad0">
                                    <svg class="octicon octicon-triangle-right triangle_blue" viewBox="0 0 6 16" version="1.1" width="6" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 14l6-6-6-6v12z"></path></svg>
