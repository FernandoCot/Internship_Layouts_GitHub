...
import StarsBody from "./StarsBody";


class UserMenuStars extends React.Component{
                ...
                {menu.map(json => (
                    <div key={json.id}>
                        <nav className="navbar_user">
                            ...
                            <Link to={"/users/"+user+"/stars"} className="user_nav_item selected">Stars
